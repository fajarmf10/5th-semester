...
display( void )
{
    ...
    /***** rotasi thd sumbu y *****/
    mat3 rotY = mat3(cos(0.001*glutGet(GLUT_ELAPSED_TIME)),  0.0,     -sin(0.001*glutGet(GLUT_ELAPSED_TIME)),
                           0.0,                                    1.0,     0.0,
                           sin(0.001*glutGet(GLUT_ELAPSED_TIME)),  0.0,     cos(0.001*glutGet(GLUT_ELAPSED_TIME)));

  	/***** rotasi thd sumbu z *****/
    mat3 rotZ = mat3(cos(0.001*glutGet(GLUT_ELAPSED_TIME)), -sin(0.001*glutGet(GLUT_ELAPSED_TIME)), 0.0,
                           sin(0.001*glutGet(GLUT_ELAPSED_TIME)), cos(0.001*glutGet(GLUT_ELAPSED_TIME)), 0.0,
                           0.0, 0.0, 1.0);

    /** nomor 14a: rotasi x lalu y **/
    //mat3 mTransform = rotY * rotX;

    /** nomor 14b: rotasi y lalu x **/
    mat3 mTransform = rotX * rotY;
...
main( int argc, char **argv )
{
    ...
    glutCreateWindow( "Tugas 14b - rotasi y, x" );
