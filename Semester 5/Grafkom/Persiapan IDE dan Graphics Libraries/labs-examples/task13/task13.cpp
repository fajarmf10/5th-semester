...
display( void )
{
    ...
    /***** rotasi thd sumbu x *****/
    mat3 yzTransform = mat3(1.0,        0.0,         0.0,
    ...
    /***** rotasi thd sumbu y *****/
    mat3 xzTransform = mat3(cos(0.001*glutGet(GLUT_ELAPSED_TIME)),  0.0,     -sin(0.001*glutGet(GLUT_ELAPSED_TIME)),
                           0.0,                                    1.0,     0.0,
                           sin(0.001*glutGet(GLUT_ELAPSED_TIME)),  0.0,     cos(0.001*glutGet(GLUT_ELAPSED_TIME)));

  	/***** rotasi thd sumbu z *****/
    mat3 xyTransform = mat3(cos(0.001*glutGet(GLUT_ELAPSED_TIME)), -sin(0.001*glutGet(GLUT_ELAPSED_TIME)), 0.0,
                           sin(0.001*glutGet(GLUT_ELAPSED_TIME)), cos(0.001*glutGet(GLUT_ELAPSED_TIME)), 0.0,
                           0.0, 0.0, 1.0);
    mat3 mTransform = yzTransform * xzTransform * xyTransform;
