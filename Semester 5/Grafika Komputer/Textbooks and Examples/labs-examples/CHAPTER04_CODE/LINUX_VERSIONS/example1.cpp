...
const GLfloat default_radius = 2.0;
...
void display( void )
{
    ...
    char title[256];
    sprintf(title, "(l,r,b,t,n,f)=(%1.2f,%1.2f,%1.2f,%1.2f,%1.2f,%1.2f), (%1.3f,%1.3f,%1.3f) ",left,right,bottom,top,zNear,zFar,radius,theta,phi);
